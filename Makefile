...
CC = g++ -O2 -fopenmp -g# -Wall #-ffast-math
...
mcluster_gpu: $(OBJECTS) $(INCPATH)/gpupot.gpu.o $(INCPATH)/functions.o
	$(CC) -c main.c -D SSE -D GPU -lm -I$(CUDA_PATH)/include
	$(CC) $(OBJECTS) main.o gpupot.gpu.o  -o mcluster_gpu $(CUFLAGS)

mcluster: include/functions.o
	$(CC) $^ -o mcluster main.c -lm

$(INCPATH)/functions.o: $(INCPATH)/functions.c
	$(CC) -lm -c $^ -o $@
